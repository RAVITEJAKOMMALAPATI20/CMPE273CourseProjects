...
class UserLogin extends Component {
   ...
   async handleClick(){
        ...
        console.log(JSON.stringify(data.data.loginuser))
        this.props.loginUser(data.data.loginuser);
    }

    render() {
        if(this.props.isLoggedIn==true){
          return  <Redirect to='/traveler/home' />
        }
        return (
...
export default compose(graphql(loginuserQuery, { name: "loginuserQuery" }),connect(mapStateToProps,{loginUser}))(withApollo(UserLogin));