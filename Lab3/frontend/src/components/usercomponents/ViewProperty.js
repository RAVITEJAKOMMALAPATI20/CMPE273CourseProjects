...
if(this.state.show){
    show = <div className="alert alert-success">
        <strong>Success!</strong> Success in booking the property Please visit My trips.
    </div>
}
        let location=null;
        let details = null;
        ...
        return(
            <div className={"viewproperty"}>
                <ul className="nav nav-tabs">
                    <li className="active"><a href="#" name="location" onClick={this.handleClick}>Location</a></li>
                    <li><a href="#" name="details" onClick={this.handleClick}>Details</a></li>
